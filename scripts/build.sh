...
go build -ldflags "-X github.com/Toinounet21/coreth-traffiqued-v0.8.0-rc.3/plugin/evm.GitCommit=$coreth_commit -X github.com/Toinounet21/coreth-traffiqued-v0.8.0-rc.3/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
